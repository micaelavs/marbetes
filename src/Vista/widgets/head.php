<?php
	...
	$vars['JS_FILES'][]['JS_FILE'] = $config['app']['endpoint_cdn']."/js/inputmask/3.3.3/min/jquery.inputmask.bundle.min.js";
	$vars['JS_FILES'][]['JS_FILE'] = $config['app']['endpoint_cdn']."/js/inputmask/is.js";
