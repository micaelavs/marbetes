...
use \FMT\Helper\Arr;
use FMT\Vista;
	$vars_vista['SUBTITULO'] = 'Imprimir/Entregar Pedido de Marbetes';
	$vars_template['CONTROL'] = 'pedido de Marbete';
	$vars_template['ARTICULO'] = 'el';
	$vars_template['TEXTO_AVISO'] = 'Entregará ';			
	$vars_template['NOMBRE'] = 'de la Empresa: '.$empresa->razon_social.'. Imprenta: ' .$imprenta->razon_social.'. Tipo de Marbete: '.$tipo_marbete->tipo;
	$vars_template['TEXTO_EXTRA'] = '.<br/>Al imprimirlo y entregarlo, no podrá modificarlo ni cambiarle el estado';
