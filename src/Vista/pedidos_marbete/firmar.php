...
use \FMT\Helper\Arr;
use FMT\Vista;
	$vars_vista['SUBTITULO'] = 'Firma de Pedido de Marbetes';
	$vars_template['CONTROL'] = 'Pedido Marbete';
	$vars_template['ARTICULO'] = 'El';
	$vars_template['TEXTO_AVISO'] = 'Firmará ';			
	$vars_template['NOMBRE'] = 'de la Empresa: '.$empresa->razon_social.'. Imprenta: ' .$imprenta->razon_social.'. Tipo de Marbete: '.$tipo_marbete->tipo;
	$vars_template['TEXTO_EXTRA'] = '.<br/>Al firmarlo, podrá visualizarlo en el Listado de Pedidos con estado Firmado';
