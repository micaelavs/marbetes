...
BEGIN
INSERT INTO {{{db_log}}}.imprenta(`id_usuario`,`fecha_operacion`,`tipo_operacion`,`id_imprenta`,`cuit`,`razon_social`,`direccion`,`fecha_ultima_revision`,`inscripcion_en_afip`,`modelo_de_marbete`,`observacion`,`borrado`)
